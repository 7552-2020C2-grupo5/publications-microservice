...
![GitHub tag (latest SemVer)](https://img.shields.io/github/v/tag/7552-2020C2-grupo5/publications_microservice?style=flat-square)
...
FLASK_APP=publications_microservice/app.py poetry run flask run
```
